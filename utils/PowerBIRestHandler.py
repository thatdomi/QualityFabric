...
class PowerBIRestHandler():
    def __init__(self, allow_browserauthenticate=False):
        self.allow_browserauthenticate = allow_browserauthenticate
    ...
    def _authenticate(self):
        ...
        auth = DefaultAzureCredential(exclude_interactive_browser_credential=self.allow_browserauthenticate)
